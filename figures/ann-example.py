...
print r"\begin{tikzpicture}[scale=0.17,inner sep=0]"

if HIGHLIGHT_ONE:
	print r"\tikzset{example/.style={uompurple,thick,minimum width=0.5em},nonexample/.style={ultra thin,white!90!black}}"
else:
